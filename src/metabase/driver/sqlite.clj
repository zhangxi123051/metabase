...
(defn- date-interval [unit amount]
  (let [[multiplier sqlite-unit] (case unit
    ...
    ;; because it's used for relative dates and only needs to be done once. It's important to call `date` on 'now' to
    ;; apply bucketing *before* adding/subtracting dates to handle certain edge cases as discussed in issue #2275
    ;; (https://github.com/metabase/metabase/issues/2275).
    ;;
