...
(defprotocol ISQLDriver
  ...
  ;; instead of `LIMIT`).
  ;; TODO - some of these can probably be replaced by `->honeysql` calls :D
  ...
  ;; TODO - this is super deprecated because we can just use `->honeysql` for this now
  (^:deprecated field->identifier [this, ^FieldInstance field]
  ...
  ;; TODO - DEPRECATED - Just have drivers override `->honeysql` for `StandardDeviationAggregation`
  (^:deprecated stddev-fn ^clojure.lang.Keyword [this]
